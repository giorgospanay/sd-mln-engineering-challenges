...
def plot_exp6(file_a,file_b,file_c,file_d):
    ...
    ax5.set_ylabel("Layer aggregation time (sec.)")
    ...
    ax6.set_ylabel("Layer aggregation time (sec.)")
    ...
    ax7.set_ylabel("Layer aggregation time (sec.)")
    ...
    ax8.set_ylabel("Layer aggregation time (sec.)")
...
def plot_exp7(file_a,file_b,file_c,file_d):
    ...
    fig1,ax1=plt.subplots()
    df1a=df1[["node_size","multinet_load","muxviz_load","netmem_load","pymnet_load","py3plex_load","mlgjl_load"]]
    df1a.plot(
        ax=ax1,
        x="node_size",
        logy=True,
    ...
    fig2,ax2=plt.subplots()
    df2a=df2[["node_size","multinet_load","muxviz_load","netmem_load","pymnet_load","py3plex_load","mlgjl_load"]]
    df2a.plot(
        ax=ax2,
        x="node_size",
        logy=True,
    ...
    fig3,ax3=plt.subplots()
    df3a=df3[["layer_size","multinet_load","muxviz_load","netmem_load","pymnet_load","py3plex_load","mlgjl_load"]]
    df3a.plot(
        ax=ax3,
        x="layer_size",
        logy=True,
    ...
    fig4,ax4=plt.subplots()
    df4a=df4[["layer_size","multinet_load","muxviz_load","netmem_load","pymnet_load","py3plex_load","mlgjl_load"]]
    df4a.plot(
        ax=ax4,
        x="layer_size",
        logy=True,
    ...
    # Plot: synth data degree time, n++ / e=4 / l=2
    fig5,ax5=plt.subplots()
    df1b=df1[["node_size","multinet_degr","muxviz_degr","netmem_degr","pymnet_degr","py3plex_degr","mlgjl_degr"]]
    df1b.plot(
        ax=ax5,
        x="node_size",
        logy=True,
    ...
    ax5.legend(["multinet","MuxViz","netmem","Pymnet","Py3plex","MLG.jl"])
    ...
    # Plot: synth data degree time, n++ / e=s / l=2
    fig6,ax6=plt.subplots()
    df2b=df2[["node_size","multinet_degr","muxviz_degr","netmem_degr","pymnet_degr","py3plex_degr","mlgjl_degr"]]
    df2b.plot(
        ax=ax6,
        x="node_size",
        logy=True,
    ...
    ax6.legend(["multinet","MuxViz","netmem","Pymnet","Py3plex","MLG.jl"])
    ...
    # Plot: synth data degree time, n=1000 / e=4 / l++
    fig7,ax7=plt.subplots()
    df3b=df3[["layer_size","multinet_degr","muxviz_degr","netmem_degr","pymnet_degr","py3plex_degr","mlgjl_degr"]]
    df3b.plot(
        ax=ax7,
        x="layer_size",
        logy=True,
    ...
    ax7.legend(["multinet","MuxViz","netmem","Pymnet","Py3plex","MLG.jl"])
    ...
    # Plot: synth data degree time, n=1000 / e=s / l++
    fig8,ax8=plt.subplots()
    df4b=df4[["layer_size","multinet_degr","muxviz_degr","netmem_degr","pymnet_degr","py3plex_degr","mlgjl_degr"]]
    df4b.plot(
        ax=ax8,
        x="layer_size",
        logy=True,
    ...
    ax8.legend(["multinet","MuxViz","netmem","Pymnet","Py3plex","MLG.jl"])
